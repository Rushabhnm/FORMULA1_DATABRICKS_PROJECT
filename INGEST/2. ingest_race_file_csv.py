...
race_final_df = race_add_df.select(col("raceID").alias("race_ID"),col("year").alias("race_year"),col("round"), col("circuitID").alias("circuit_ID"),col("name"),col("date"),col("time"),col("url"),col("race_timestamp"),col("ingestion_date"),col("extraction_file"), col("data_source"))
